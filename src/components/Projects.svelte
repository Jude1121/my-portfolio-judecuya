...
<div class="lg:p-50 bg-black text-white w-full lg:pt-30 pt-15 p-10" >
        ...
        <div class="lg:flex justify-center lg:justify-baseline gap-30">
             <div class="lg:w-155 pt-10 lg:pt-25 transform transition-transform duration-300 hover:scale-105 ">
            ...
            <div class="lg:w-150  pt-10">
                <h1 class="lg:pt-20 sm:pl-5  font-bold flex justify-center">
