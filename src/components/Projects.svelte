...
<div class="lg:p-50 bg-black text-white w-full lg:pt-30 pt-15 p-10" >
        <h1 class="text-4xl font-extrabold flex justify-center">
            PROJECT
        </h1>
        <div class="lg:flex justify-center lg:justify-baseline gap-30">
             <div class="lg:w-180 pt-10 lg:pt-25 transform transition-transform duration-300 hover:scale-105">
            ...
            <div class="lg:w-190  pt-10">
                <h1 class="lg:pt-20 sm:pl-5 text-xl  font-bold flex justify-center">
                        VILLA SALOME HOTEL AND RESORT ONLINE MANANGEMENT SYSTEM - UI/UX FIGMA PROTOTYPE               
                </h1>
                <p class="lg:pt-5 sm:pl-5  pt-5 pb-8">
                ...
                <div class="lg:pl-5 sm:pl-5">
                    <div class="w-fit font-extrabold bg-white text-black transform transition-transform duration-300 hover:scale-120 ">
